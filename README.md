...
Lokalen MySQL-Server starten und anschliessend folgende DB-script in Angular-Projekt ausführen: create-prod-db.sql
...
### End2End-Tests
Lokalen MySQL-Server starten und anschliessend folgende DB-script in Angular-Projekt ausführen: create-test-db.sql

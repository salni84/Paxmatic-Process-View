...
DROP table if exists process_Server.basicprocess, process_Server.subprocess, process_Server.departmentprocess, process_Server.detailprocess, process_Server.documents;
...
INSERT into process_Server.detailprocess (id, level, name, color, form, position, parent, visibleName, isVisible, `order`, isBubble)
VALUES
